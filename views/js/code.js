...
function ViewPendingRecordsPage() {
  location.href = "/pendingrecords";
}

function ViewKeywordsPage() {
  location.href = "/pendingkeywords";
}

function ViewDuplicatePage() {
  location.href = "/duplicatenames";
}

function ViewDuplicateWebsitesPage() {
  location.href = "/duplicatewebsites";
}

function StartWorkingPage() {
  location.href = "/dashboard";
}

function ProcessBingURL() {
  location.href = "/processbingurl";
}
